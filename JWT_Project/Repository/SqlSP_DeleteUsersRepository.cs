...
{
    public class SqlSP_DeleteUsersRepository : ISP_DeleteUsersRepository
    {
        private readonly ApplicationDbContext dbContext;
        public SqlSP_DeleteUsersRepository(ApplicationDbContext dbContext)
        {
        ...
        public async Task<List<ApiResponseMessage>> getasync(SP_DeleteUsers input)
        {
            ...
            {
                command.CommandText = "[SP_DeleteUsers]";
